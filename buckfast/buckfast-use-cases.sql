...
-- 4
SELECT C.FIRST_NAME AS CUSTOMER_FIRST, C.LAST_NAME AS CUSTOMER_LAST, BUSINESS_NAME, E.FIRST_NAME AS EMP_FIRST, E.LAST_NAME AS EMP_LAST, ASSI.START_DATE AS SCHEDULE_START
