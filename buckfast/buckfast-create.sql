...
CREATE INDEX "FK" ON  "Customer" ("Customer_Address_ID");
...
CREATE INDEX "FK" ON  "GuestHouse" ("Store_ID", "Schedule_ID");
...
CREATE INDEX "FK" ON  "Store_Entity" ("Business_Type_ID", "Schedule_ID", "Store_Business_Type_ID");
...
CREATE INDEX "FK" ON  "StoreInventory_LineItem" ("ProductID", "StoreInventory_ID");
